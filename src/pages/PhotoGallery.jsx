...
export default function PhotoGallery() {
  ...
  return (
    <>
      ...
      <div className="flex flex-col bg-gradient-to-br from-slate-50 to-slate-100" style={{ height: 'calc(100vh - 80px)' }}>
      {/* Main Content */}
                ...
                <div className="bg-white rounded-xl shadow-xl overflow-hidden">
                  ...
                  <div className="p-6 bg-white">
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        {selectedPhoto.metadata && selectedPhoto.metadata.ai_model && (
                          <div className="mb-3">
                            <span className="inline-flex items-center gap-1.5 px-3 py-1 text-xs font-semibold bg-gradient-to-r from-purple-100 to-blue-100 text-purple-700 rounded-full border border-purple-200">
                              🤖 Analysé par {
                    ...
                    {selectedPhoto.metadata && (
                      <div className="mt-4 p-4 bg-gradient-to-br from-slate-50 to-blue-50 rounded-lg space-y-4 border border-slate-200">
                        {/* Description */}
                            ...
                            <div className="space-y-3">
                              ...
                              <div className="grid grid-cols-3 gap-2 text-xs">
                                <div className="bg-white p-2 rounded-lg text-center">
                                  <div className="font-medium text-slate-700">Netteté</div>
                                ...
                                <div className="bg-white p-2 rounded-lg text-center">
                                  <div className="font-medium text-slate-700">Éclairage</div>
                                  <div className={`mt-1 capitalize font-semibold ${
                                ...
                                <div className="bg-white p-2 rounded-lg text-center">
                                  <div className="font-medium text-slate-700">Composition</div>
                                  <div className={`mt-1 capitalize font-semibold ${
            ...
            <div className="mb-4">
              <div className="flex items-center justify-between">
                ...
                {selectedPhoto && selectedPhoto.metadata && selectedPhoto.metadata.ai_model && (
                  <span className="inline-flex items-center px-2 py-0.5 text-xs font-semibold bg-gradient-to-r from-purple-100 to-blue-100 text-purple-700 rounded-full border border-purple-200">
